...
@section('css')
    ...
    {{--    <link href="{{asset('public/frontend/nitmtheme/css/myProfile.css')}}{{assetVersion()}}" rel="stylesheet"/>--}}
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/nitmtheme/css/student_profile.css')}}{{assetVersion()}}">
    <style>
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/nitmtheme') }}/js/gijgo.min.js"></script>
    <!-- tag input css -->
