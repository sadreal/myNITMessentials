...
<head>
    ...
    @if(isRtl())
        <link rel="stylesheet"
              href="{{ asset('public/frontend/nitmtheme') }}/css/bootstrap.rtl.min.css{{assetVersion()}} ">
    @else
        <link rel="stylesheet"
              href="{{ asset('public/frontend/nitmtheme') }}/css/bootstrap.min.css{{assetVersion()}} ">
    @endif

    <link rel="stylesheet" href="{{asset('public/backend/css/themify-icons.css')}}{{assetVersion()}}"/>
    <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/notification.css{{assetVersion()}}">
    <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme/css/mega_menu.css') }}">
    ...
    @if(isRtl())
        <link rel="stylesheet"
              href="{{ asset('public/frontend/nitmtheme') }}/css/frontend_style_rtl.css{{assetVersion()}}"
              media="screen,print">
    @else
        <link rel="stylesheet"
              href="{{ asset('public/frontend/nitmtheme') }}/css/frontend_style.css{{assetVersion()}}"
              media="screen,print">
    @endif
    <script src="{{asset('public/frontend/nitmtheme')}}/js/common.js{{assetVersion()}}"></script>
    @yield('css')

    <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme/css/custom.css') }}">
</head>
