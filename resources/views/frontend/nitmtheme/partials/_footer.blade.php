<div class="aoraeditor-skip aoraeditor-footer">
    ...
    <script src="{{ asset('public/frontend/nitmtheme/js/map.js') }}"></script>
    <script src="{{asset('public/frontend/nitmtheme/js/contact.js')}}{{assetVersion()}}"></script>
    ...
    @if (isModuleActive("Store"))
        <script src="{{asset('public/frontend/nitmtheme/js/store_script.js')}}{{assetVersion()}}"></script>
    ...
    <script src="{{ asset('public/frontend/nitmtheme/js/custom.js') }}{{assetVersion()}}"></script>
