...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/fluidplayer.min.css">

    {{--    <link rel="stylesheet" href="{{asset('public/backend/css/style.css')}}"/>--}}
    <link rel="stylesheet" href="{{asset('public/css/preloader.css')}}"/>
    @if(isRtl())
        <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/bootstrap.rtl.min.css">
    @else
        <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/bootstrap.min.css">
    @endif

    <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/app.css">
    <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/fontawesome.css ">
    <link rel="stylesheet" href="{{asset('public/backend/css/themify-icons.css')}}"/>
    @if(isRtl())
        <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/frontend_style_rtl.css">
    @else
        <link rel="stylesheet" href="{{ asset('public/frontend/nitmtheme') }}/css/frontend_style.css">
    @endif
    <script src="{{asset('public/frontend/nitmtheme')}}/js/common.js{{assetVersion()}}"></script>
...
<script src="{{ asset('public/frontend/nitmtheme') }}/js/fluidplayer.min.js"></script>
