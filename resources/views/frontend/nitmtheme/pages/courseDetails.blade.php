...
@section('css')
    ...
    <link href="{{asset('public/frontend/nitmtheme/css/videopopup.css')}}{{assetVersion()}}" rel="stylesheet"/>
    <link href="{{asset('public/frontend/nitmtheme/css/video.popup.css')}}{{assetVersion()}}" rel="stylesheet"/>
