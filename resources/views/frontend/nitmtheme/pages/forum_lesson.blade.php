...
@endsection
@section('css')
    <link rel="stylesheet" href="{{asset('public/frontend/nitmtheme/css/forum.css')}}{{assetVersion()}}">

@endsection
@section('js')
    <script src="{{asset('public/frontend/nitmtheme/js/forum.js')}}{{assetVersion()}}"></script>
@endsection
