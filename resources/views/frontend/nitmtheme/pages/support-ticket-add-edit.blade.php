...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/nitmtheme/css/support.css')}}{{assetVersion()}}">
@endsection
@section('js')
    <script src="{{asset('public/frontend/nitmtheme/js/support.js')}}{{assetVersion()}}"></script>
@endsection
                                ...
                                <div class="support_main_create">
                                 ...
                                 @if($new)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 text-end mobile-center mt-md-4">
